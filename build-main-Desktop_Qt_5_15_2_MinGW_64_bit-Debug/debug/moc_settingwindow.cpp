...
QT_MOC_LITERAL(3, 22, 11) // "emit_goback"

    },
    "settingWindow\0goBack\0\0emit_goback"
};
...
void settingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&settingWindow::goBack)) {
                *result = 0;
                return;
            }
        }
