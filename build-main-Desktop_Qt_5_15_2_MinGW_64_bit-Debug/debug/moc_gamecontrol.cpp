...
QT_MOC_LITERAL(8, 123, 14), // "QVector<Card>&"
QT_MOC_LITERAL(9, 138, 5) // "cards"

    },
    "GameControl\0callGamewindowShowCards\0"
    "\0callGamewindowShowBets\0Player*\0"
    "callGamewindowShowLandlord\0"
    "NotifyPlayerPlayHand\0player\0QVector<Card>&\0"
    "cards"
};
...
void GameControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->NotifyPlayerPlayHand((*reinterpret_cast< Player*(*)>(_a[1])),(*reinterpret_cast< QVector<Card>(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (GameControl::*)(Player * , QVector<Card> & );
...
// SIGNAL 3
void GameControl::NotifyPlayerPlayHand(Player * _t1, QVector<Card> & _t2)
{
